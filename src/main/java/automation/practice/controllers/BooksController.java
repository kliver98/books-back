...
public class BooksController {
  ...
  public BookDto[] getBooks() {
    ...
    return new BookDto[] {
      ...
      new BookDto("Agile Software Development: Principles, Patterns, and Practices", REPEATED_AUTHORS),
      ...
      new BookDto("The Clean Coder: A Code of Conduct for Professional Programmers", REPEATED_AUTHORS),
      ...
      new BookDto("Clean Code: A Handbook of Agile Software Craftsmanship", REPEATED_AUTHORS),
    };
  }
}
